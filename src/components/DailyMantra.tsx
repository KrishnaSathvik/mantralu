...
export function DailyMantra() {
  ...
  return (
    <Link
      ...
      className="block rounded-xl border-2 border-primary/20 bg-gradient-to-br from-primary/5 via-card to-primary/10 p-5 transition-all hover:shadow-lg hover:border-primary/40"
    >
